...
class _BodyState extends State<Body> with RouteAware {
  ...
  String getAddressLine(dynamic address) {
                            ...
                            child: Column(
                              children: List.generate(
                                ...
                                (index) => Container(
                                  ...
                                  width: double.infinity,
                                  height: 70, // Updated height to 70
  ...
  Widget buildAddressItemCard(String addressId) {
    return Padding(
      ...
      child: Stack(
        children: [
          // The delete background always fills the area
          ClipRRect(
            borderRadius: BorderRadius.circular(12),
            child: Container(
          ...
          Dismissible(
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                BorderRadius cardRadius = BorderRadius.circular(12);
